...
BEGIN_OBJECT_REFLECTOR(Parent)
    ...
    I_Constructor0(____Parent,
        "",
        "");
    I_Method0(const char *, identify,
	          Properties::VIRTUAL,
	          __C5_char_P1__identify,
...
BEGIN_OBJECT_REFLECTOR(Acceptor)
    ...
    I_Constructor0(____Acceptor,
        "",
        "");
	I_Method1(void, acceptParentPtr, IN, Parent *, p,
	...
	I_Method1(void, acceptParentPtrConst, IN, const Parent *, p,
	          Properties::NON_VIRTUAL,
	          __void__acceptParentPtrConst__C5_Parent_P1,
	          "",
	          "");
	I_Method1(void, acceptParentRef, IN, Parent &, p,
	          Properties::NON_VIRTUAL,
	...
	I_Method1(void, acceptParentRefConst, IN, const Parent &, p,
	          Properties::NON_VIRTUAL,
	          __void__acceptParentRefConst__C5_Parent_R1,
	          "",
	          "");
END_REFLECTOR
